...
export const ProcessDocumentOutputSchema = z.object({
  ...
  }).describe("The extracted recipient information.").optional(),
  items: z.array(ItemSchema).describe("An array of invoice items extracted from the document. If no items are found, this can be empty.").optional()
});
